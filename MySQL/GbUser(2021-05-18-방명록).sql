...
VALUES ('2021-05-18','10:2:00','callor','wndeld777@gmail.com','12345','내일은 석가탄식일');
...
-- UPDATE, DELETE를 수행할때는 2개 이상의 레코드에 영향이 미치는 명령은 매우 신중하게 실행해야 한다
-- 가장 좋은 방법은 변경, 삭제하고자 하는 데이터가 여러개 있더라도 가급적 PK를 기준으로 1개씩 처리하는것이 좋다 
...
-- gb_seq 의 값이 짝수이면 짝수로 표시 아니면 홀수로 표시

...
-- 일반적인 코딩과 달리 정수부분도 반올림 연산을 수행할 수 있다
...
-- 실제 날짜값으로 변환하여 표현하기
-- 문자열로 되어있는 날짜 시간을 실제 Date Type의 데이터로 변환
...
SELECT ROUND(TO_DATE('2021-04-2811:27:00','yyyy-mm-ddhh:mi:ss')) FROM DUAL;

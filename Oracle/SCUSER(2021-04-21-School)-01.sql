...
CREATE TABLE tbl_student(
    ...
    st_grade VARCHAR2(5), -- 숫자값을 입력, 숫자값을 문자형으로 인식하도록
    st_tel VARCHAR2(20),
...
-- Table의 제약조건을 설정할때 UNIQUE는 매우 신중하게 선택해야 한다

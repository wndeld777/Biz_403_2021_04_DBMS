...
VALUES('00003',90,80,70);

-- 위에서 생성한 tbl_score 는 중복된 학번의 점수가 INSERT 될수 있다
-- 한 학생의 점수가 2중 3중으로 INSERT되어 엉뚱한 결과가 나타 날 수 있다.
-- 제약조건부여
...
-- 다른과목의 점수는 감추고 싶다
-- 보안적인 측면에서 사용자별로
-- 보여줄항목, 보이지 않을 항목을 선별하여 VIEW작성을 해두면

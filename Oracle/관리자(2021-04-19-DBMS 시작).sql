...
-- mydb라는 이름으로 사용하겠다
-- 데이터가 있든 없던간에 기본 크기를 10MByte로 설정해 달라
...
--  나. Oracle DBMS 서버는 명령을 수신한후 문법검사를 하고
